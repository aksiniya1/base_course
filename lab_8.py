...
ax1.plot_surface(X_par, Y_par, Z_par, alpha=0.8)
ax1.set_title('Параболид')

ax2 = fig.add_subplot(222, projection='3d')
ax2.plot_surface(X_hyp, Y_hyp, Z_hyp, alpha=0.8)
ax2.set_title('Гиперболид')

ax3 = fig.add_subplot(223, projection='3d')
ax3.plot_surface(X_hel, Y_hel, Z_hel, alpha=0.8)
ax3.set_title('Геликоид')

ax4 = fig.add_subplot(224, projection='3d')
ax4.plot_surface(X_con, Y_con, Z_con, alpha=0.8)
